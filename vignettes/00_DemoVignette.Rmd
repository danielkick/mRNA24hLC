...
process_gjvc_trace <- function(trace = trace_list$GJVC){
  ...
  ### Ileak ####
  In4_R <- as.numeric(broom::tidy(lm(In4Mean ~ In7Mean,  data = i_leak_for_In4_to_In9))[2, "estimate"])
  In9_R <- as.numeric(broom::tidy(lm(In9Mean ~ In12Mean, data = i_leak_for_In9_to_In4))[2, "estimate"])
