...
# TODO Dave asked I confirm activity was present prior to measurements for 1h, 24h
```
...
```{r}
temp <- metadata %>% select(Experiment#, Page, Recording, FileName, In4, In9
                            ) %>% distinct

write.csv(temp, file = "C:/Users/Daniel/Desktop/test.csv", row.names = F)
# <!-- ``` -->
...
```{r user defined functions, eval=FALSE, include=FALSE}
