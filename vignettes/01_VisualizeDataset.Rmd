...
tevc <-
  ...
  rename(Channel = PreSyn,
         ig = MedianIg)
#TODO we should really code gap junction conductance based on the two cells it's connecting.
...
tecc_cols <- c("vrest", "cc", "r11", "r1")#, "r12", "rc.ig") # ignore rc, ig is a more direct measure
tevc_cols <- c("ig.3_4", "ig.3_5", "ig.4_3", "ig.4_5", "ig.5_3", "ig.5_4")
